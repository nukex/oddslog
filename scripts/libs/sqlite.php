...
class SQLite
{
    ...
    public function __construct($type = null, $host = null, $username = null, $password = null, $dbname = null, $port = null, $charset = null) {
        set_exception_handler(function($exception) {
            echo '<b>[SQL] Exception:</b> ' . $exception->getMessage();
        });
    ...
    public function insertArray($table, $array)
    {
        ...
        foreach ($values as $key => $value) {
            $set []= '( ' . implode(' , ', array_map('add_quotes', $value) ) . ' )';
        }

        $this->query = " INSERT INTO `$table` VALUES " . implode(" , \n", $set);
        $this->table = $table;
        $this->action = 'insert';
